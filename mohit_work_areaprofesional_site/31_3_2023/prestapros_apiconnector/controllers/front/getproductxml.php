 ...
 */
class prestapros_apiconnectorGetproductxmlModuleFrontController extends ModuleFrontController
{
	...
	public function getproductinformation($pid,$shopdomain,$languageid)
	{
		...
		if($languageid>0)
		{
				   $link="https://".$keyget."@".$shopdomain."/api/products/".$pid."?ws_key=".$keyget."&language=".$languageid;
		}
		else
		{
				  $link="https://".$keyget."@".$shopdomain."/api/products/".$pid."?ws_key=".$keyget."";
