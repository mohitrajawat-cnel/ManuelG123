 ...
 */
class prestapros_apiconnectorDeliveryaddresslistModuleFrontController extends ModuleFrontController
{
	...
	public function getproductinformation($pid,$shopdomain,$languageid)
	{
		...
		if($languageid>0)
		{
				   $link="https://".$keyget."@".$shopdomain."/api/addresses/".$pid."?ws_key=".$keyget."&output_format=JSON&language=".$languageid;
		}
		else
		{
				  $link="https://".$keyget."@".$shopdomain."/api/addresses/".$pid."?ws_key=".$keyget."&output_format=JSON";
